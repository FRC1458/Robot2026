...
public class CompCtreDriveConstants {
	...
	public static final int kPigeonId = 60;
	...
	public static final double kS_sysid_drive = 0.12903;
	public static final double kV_sysid_drive = 2.3293;
	public static final double kA_sysid_drive = 0.41181;
	public static final double kP_sysid_drive = 2.2622;
	public static final double kD_sysid_drive = 0.0;

	// convert sysid gains into CTRE (rotation/s) units
	public static final double kS_ctre_drive = kS_sysid_drive;
	public static final double sysIdToCTRE =
			Constants.TAU * kWheelRadius.in(Meters) / kDriveGearRatio;
	public static final double kV_ctre_drive = kV_sysid_drive * sysIdToCTRE;
	public static final double kA_ctre_drive = kA_sysid_drive * sysIdToCTRE;
	public static final double kP_ctre_drive = kP_sysid_drive * sysIdToCTRE;
	public static final double kD_ctre_drive = kD_sysid_drive * sysIdToCTRE;
	...
	// Front Left
	public static final int kFrontLeftDriveMotorId = 8;
	public static final int kFrontLeftSteerMotorId = 10;
	public static final int kFrontLeftEncoderId = 7;
	public static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.224365234375);
	public static final boolean kFrontLeftSteerMotorInverted = true;
	public static final boolean kFrontLeftEncoderInverted = false;

	public static final Distance kFrontLeftXPos = Inches.of(10.875);
	public static final Distance kFrontLeftYPos = Inches.of(10.875);
	...
	public static final Angle kFrontRightEncoderOffset = Rotations.of(0.431640625);
	...
	public static final Distance kFrontRightXPos = Inches.of(10.875);
	public static final Distance kFrontRightYPos = Inches.of(-10.875);
	...
	public static final Angle kBackLeftEncoderOffset = Rotations.of(-0.2119140625);
	public static final boolean kBackLeftSteerMotorInverted = true;
	public static final boolean kBackLeftEncoderInverted = false;

	public static final Distance kBackLeftXPos = Inches.of(-10.875);
	public static final Distance kBackLeftYPos = Inches.of(10.875);
	...
	public static final Angle kBackRightEncoderOffset = Rotations.of(-0.1064453125);
	public static final boolean kBackRightSteerMotorInverted = true;
	public static final boolean kBackRightEncoderInverted = false;

	public static final Distance kBackRightXPos = Inches.of(-10.875);
	public static final Distance kBackRightYPos = Inches.of(-10.875);
	 ...
	 * program,.
	 */
	public static CtreDrive createDrivetrain() {
		return new CtreDrive(DrivetrainConstants, FrontLeft, FrontRight, BackLeft, BackRight);
	}
