//
// Dc.10.24.25, all code in this file can be replaced (ctrl-a+ctrl-v) with PhoenixTunerX generated code, except for the two class names used (CtreDriveConstants and CtreDrive ) in this file
// updated 10/4/25: 
...
public class CtreDriveConstants {   
    ...
    static double kD_sysid_drive = 0.;
    // covnert sysid gains into CTRE (rotation/s) units
    static double kS_ctre_drive = kS_sysid_drive;
    static double kV_ctre_drive = kV_sysid_drive * (2.0*Math.PI*kWheelRadius.in(Meters)/kDriveGearRatio);
    ...
    static double kD_ctre_drive = kD_sysid_drive * (2.0*Math.PI*kWheelRadius.in(Meters)/kDriveGearRatio);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.355224609375);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.4296875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.0869140625);
