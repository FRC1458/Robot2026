...
public final class Constants {
	...
	public static class FieldConstants {
		public static Translation2d hubLocation = new Translation2d();
		...
		public static class LinesVertical {
			...
			public static final double hubCenter =
					FieldLayout.APRILTAG_MAP.getTagPose(26).get().getX() + Hub.width / 2.0;
			public static final double neutralZoneNear =
					center - edu.wpi.first.math.util.Units.inchesToMeters(120);
			public static final double neutralZoneFar =
					center + edu.wpi.first.math.util.Units.inchesToMeters(120);
			public static final double oppHubCenter =
					FieldLayout.APRILTAG_MAP.getTagPose(4).get().getX() + Hub.width / 2.0;
			public static final double oppAllianceZone =
					FieldLayout.APRILTAG_MAP.getTagPose(10).get().getX();
		}
		...
		public static class LinesHorizontal {
			...
			public static final double rightTrenchOpenStart =
					rightBumpEnd - edu.wpi.first.math.util.Units.inchesToMeters(12.0);
			...
			public static final double leftTrenchOpenEnd =
					leftBumpStart + edu.wpi.first.math.util.Units.inchesToMeters(12.0);
		...
		public static class Hub {
			...
			public static final double height =
					edu.wpi.first.math.util.Units.inchesToMeters(72.0); // includes the
			// catcher at the
			// top
			...
			public static final Pose2d nearFace =
					FieldLayout.APRILTAG_MAP.getTagPose(26).get().toPose2d();
			...
			public static final Pose2d leftFace =
					FieldLayout.APRILTAG_MAP.getTagPose(21).get().toPose2d();
		}
		...
		public static class LeftTrench {
			...
			public static final double openingHeight =
					edu.wpi.first.math.util.Units.inchesToMeters(22.25);
		...
		public static class Tower {
			...
			public static final double innerOpeningWidth =
					edu.wpi.first.math.util.Units.inchesToMeters(32.250);
			...
			public static final double highRungHeight =
					edu.wpi.first.math.util.Units.inchesToMeters(63.0);

			// Relevant reference points on alliance side
			public static final Translation2d centerPoint =
					new Translation2d(frontFaceX, FieldLayout.APRILTAG_MAP.getTagPose(31).get().getY());
			...
			public static final Translation2d oppCenterPoint =
					new Translation2d(
							fieldLength - frontFaceX, FieldLayout.APRILTAG_MAP.getTagPose(15).get().getY());
		...
		public static class Depot {
			...
			public static final double distanceFromCenterY =
					edu.wpi.first.math.util.Units.inchesToMeters(75.93);
		...
		public static class Outpost {
			...
			public static final double openingDistanceFromFloor =
					edu.wpi.first.math.util.Units.inchesToMeters(28.1);
			public static final double height = edu.wpi.first.math.util.Units.inchesToMeters(7.0);

			// Relevant reference points on alliance side
			public static final Translation2d centerPoint =
					new Translation2d(0, FieldLayout.APRILTAG_MAP.getTagPose(29).get().getY());
		}
	}
}
