...
public class ControlsMapping {
	public static void mapTeleopCommand() {
		...
		controller.povUp().onTrue(AlgaeArm.getInstance().moveToAngle(AlgaeArmConstants.Angles.STOW));
		controller.povDown().onTrue(AlgaeArm.getInstance().moveToAngle(AlgaeArmConstants.Angles.DEPLOY));
	}
