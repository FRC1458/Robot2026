...
public final class DriveConstants {
	...
	public static final double MAX_ROTATION_SPEED =
			Units.RotationsPerSecond.of(1.0).in(Units.RadiansPerSecond);
	...
	public static final double WHEEL_DIAMETER =
			2 * CompCtreDriveConstants.kWheelRadius.in(Units.Meters);
	...
	public static enum FieldPoses {
		HUB(new Pose3d(Constants.FieldConstants.Hub.topCenterPoint, Rotation3d.kZero)),
		TRENCH(FieldLayout.APRILTAG_MAP.getTagPose(12).orElse(Pose3d.kZero)),
		TAG(FieldLayout.APRILTAG_MAP.getTagPose(12).orElse(Pose3d.kZero));
		public Pose2d pose;
