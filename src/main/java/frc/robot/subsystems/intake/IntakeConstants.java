...
public class IntakeConstants {
	...
	public static final Mass INTAKE_MASS = Pounds.of(7.0); // kg, ideally
	public static final Distance INTAKE_LENGTH = Inches.of(7.45); // m, hopefully
	public static final MomentOfInertia MOI = InchSqPounds.of(524.616088);
	...
	public static final AngularVelocity OUTTAKE_SPEED = RotationsPerSecond.of(-50);
	...
	public static final TalonFXConfiguration ROLLER_CONFIG =
			new TalonFXConfiguration()
					.withSlot0(new Slot0Configs().withKV(0.0).withKP(1.0).withKI(0.0).withKD(0.0))
					.withCurrentLimits(
