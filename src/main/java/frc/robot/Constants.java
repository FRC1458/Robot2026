...
public final class Constants {
	...
	public static class FieldConstants {
		public static Translation3d allianceCorrected(Translation3d t) {
			...
			if (a == Alliance.Red) {
				var t2d = 
					FieldUtil.flipTranslation(t.toTranslation2d());
		...
		public static class LinesVertical {
			...
			public static final double starting =
				FieldLayout.APRILTAG_MAP.getTagPose(26).get().getX();
		...
		public static class LinesHorizontal {
			...
			public static final double rightTrenchOpenStart = rightBumpEnd - edu.wpi.first.math.util.Units.inchesToMeters(12.0);
			...
			public static final double leftTrenchOpenEnd = leftBumpStart + edu.wpi.first.math.util.Units.inchesToMeters(12.0);
		...
		public static class Hub {
			...
			public static final Pose2d farFace =
				FieldLayout.APRILTAG_MAP.getTagPose(20).get().toPose2d();
		...
		public static class LeftBump {
			...
			// Relevant reference points on alliance side
			public static final Translation2d nearLeftCorner =
				new Translation2d(LinesVertical.hubCenter - width / 2, edu.wpi.first.math.util.Units.inchesToMeters(255));
