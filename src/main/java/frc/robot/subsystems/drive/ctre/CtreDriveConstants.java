//
// Dc.10.24.25, all code in this file can be replaced (ctrl-a+ctrl-v) with PhoenixTunerX generated
// code, except for the two class names used (CtreDriveConstants and CtreDrive ) in this file
// updated 10/4/25:
// - EncoderOffset of 4 steering motors tuned,
// - steerGains.kV value need to be verified.
//
...
// TODO: Someone please separate the constants this isnt good for the coders
// Generated by the Tuner X Swerve Project Generator
// https://v6.docs.ctr-electronics.com/en/stable/docs/tuner/tuner-swerve/index.html
public class CtreDriveConstants {
	// which set of robot constants we are deploy
	private static final boolean kCompBot =
			true; // true for the 2nd bot we built for 2026; false for 2025 bot
	...
	static double kA_sysid_drive = 0.41181;
	static double kP_sysid_drive = 2.2622;
	static double kD_sysid_drive = 0.0;

	// convert sysid gains into CTRE (rotation/s) units
	static double kS_ctre_drive = kS_sysid_drive;
	static double sysIdToCTRE = Constants.TAU * kWheelRadius.in(Meters) / kDriveGearRatio;
	static double kV_ctre_drive = kV_sysid_drive * sysIdToCTRE;
	static double kA_ctre_drive = kA_sysid_drive * sysIdToCTRE;
	static double kP_ctre_drive = kP_sysid_drive * sysIdToCTRE;
	static double kD_ctre_drive = kD_sysid_drive * sysIdToCTRE;
	...
	private static final double kCoupleRatio =
			kDriveGearRatio / (150. / 7.); // (drive gear ratio)/(steering gear ratio) 3.5714285714285716;
	...
	private static final Angle kFrontLeftEncoderOffset =
			Rotations.of(kCompBot ? -0.419922 : 0.355224609375);
	...
	private static final Angle kFrontRightEncoderOffset =
			Rotations.of(kCompBot ? 0.141113 : -0.4296875);
	...
	private static final Angle kBackLeftEncoderOffset =
			Rotations.of(kCompBot ? -0.460693 : 0.326416015625);
	...
	private static final Angle kBackRightEncoderOffset =
			Rotations.of(kCompBot ? 0.193604 : 0.0869140625);
